Public Class Question5Niveau1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim welcomego As New Question6Niveau1
        welcomego.Show()
        Me.Close()
    End Sub
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Else
            ...
            End If
            Question6Niveau1.Show()
        End If
    End Sub

    Private Sub Question5Niveau1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
