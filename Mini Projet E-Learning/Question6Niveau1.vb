Public Class Question6Niveau1
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Else
            ...
            End If
            Question7Niveau1.Show()
        End If
    End Sub

    Private Sub Question6Niveau1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim welcomego As New Question7Niveau1
        welcomego.Show()
        Me.Close()
    End Sub
